...
// --- NIRF 2025 data (Colleges category) ---
export const NIRF_DATA = [
...
// --- Market reputation ranking ---
export const MARKET_RANKING_DATA = [
...
export const TOP_SCIENCE = ["miranda-house-w", "hindu-college", "hansraj-college", "sri-venketeswara-college", "kirori-mal-college"];
export const TOP_COMMERCE = ["shri-ram-college-of-commerce", "sri-guru-gobind-singh-college-of-commerce", "shaheed-sukhdev-college-business-studies", "hansraj-college", "atma-ram-sanatan-dharma-college"];
export const TOP_HUMANITIES = ["lady-shri-ram-college-for-women-w", "miranda-house-w", "indraprastha-college-for-women-w", "ramjas-college", "hindu-college"];
...
export const RANK_BY_ID = {
  ...
  // Medical (56-61)
  // Law (62-64)
  // Nursing & allied health (65-70)
  // Specialized institutes (71-83)
  "college-of-art": 71,
  "delhi-school-of-journalism": 72,
  "cluster-innovation-centre": 73,
  "department-of-germanic-and-romance-studies": 82,
  "department-of-slavonic-and-finno-ugrian-studies": 83,
};
